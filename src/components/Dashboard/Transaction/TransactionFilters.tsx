...
export function TransactionFilters({
  ...
  return (
    <div className="space-y-4">
      <div className="space-y-4 flex w-full items-start gap-x-4 lg:flex-col">
        {/* Search */}
        <div className="flex-1 w-full rounded-lg border border-border bg-card p-4">
          ...
          <div className="mb-4 space-y-2">
            ...
            <label className="flex cursor-pointer items-center gap-2">
              <input
                ...
                onChange={() =>
                  setFilters({ ...filters, filterMode: "custom" })
                }
                className="h-4 w-4"
              />
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => {
                    ...
                    const month =
                      filters.dateRange.split("-")[1] || currentMonth;
                    setFilters({ ...filters, dateRange: `${year}-${month}` });
                  }}
                  className="w-full rounded border border-input bg-background px-3 py-2 text-sm text-foreground focus:border-primary focus:outline-none"
                >
